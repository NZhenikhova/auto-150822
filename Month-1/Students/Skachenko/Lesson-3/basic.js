...
/* Comments Task 2
1. result эта переменная я не вижу чтобы она была глобальной 
(глобальная это значит она задекларирована вне функции let result), 
это значит что ее нужно декларировать внутри функции
const or let, пожалуйста, следи за этим
*/
