...
/* Comments Task1
1. Пользуйтесь комментами для условия задачи, а то не компилирует
2. Обрати внимание на вот это let apart = (square,street)>= , тут есть ошибка в синтаксисе,
 чтобы избегать таких ошибок лучше каждый раз пробовать заранить свой код после написания!
 =>
Снова ошибка компиляции!
*/
///2
...
/* Comments Task2
1. Переменный/функцию нужно начинать писать с маленькой буквы
*/     

///3
// Напишите стрелочную функцию которая проверит тип данных аргумента на 
// ‘string’ и выведет в консоль true.
...
/* Comments Task3
0. Мы не называем функции и переменные ключевыми словами const string 
