...
1) $*("//div[@class='page-title']/h1");
2) $*("//ul[@class='blog-pagination']/li[3]/a");
3.1 //* [contains (text()='April 11, 2022 '];
3.2 //* [contains (text()='James Messi'];

Home task: https://www.beaxy.com/contact-us/
Найти все селекторы для формы:
1)Your Name - //div[@class='rendered-form']/div/div/input
2)Email - //div[@class='formbuilder-text form-group field-text-1657528683863-0']/input
